  ...
  def nav_buttons
    if logged_in?
      content_tag :div do
        ...
        content_tag(:button, 'New Event', onclick: "location.href = '../events/new';", class: 'btn btn-success mr-2') +
        content_tag(:button, 'Show Events', onclick: "location.href = '../show_events';", class: 'btn btn-success mr-2') +
        content_tag(:button, current_user.name, onclick: "location.href = '../users';", class: 'btn btn-success mr-2') +
